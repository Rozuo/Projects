...
gSounds = {
    ...
    ['flag-spawn'] = love.audio.newSource('sounds/flag-spawn.wav'),
    ['new-level'] = love.audio.newSource('sounds/new-level.wav')
}
...
gTextures = {
    ...
    ['flags'] = love.graphics.newImage('graphics/flag.png'),
