...
function GenerateQuadsBricks(atlas)
    local brickTable = table.slice(GenerateQuads(atlas, 32, 16), 1, 21)
    local lockBrick = table.slice(GenerateQuads(atlas, 32, 16), 24, 24)
    table.insert( brickTable, lockBrick[1])
    return brickTable
end
