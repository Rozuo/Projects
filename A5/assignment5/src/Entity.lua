...
function Entity:init(def)
    ...
    -- a variable to not exceed the max health when healing
...
-- this function will heal the entity by a set amount but if the hp that will be added to the health will exceed then the health will simply equal the max health.
function Entity:heal(hp)
    if(self.health + hp > self.maxHealth) then
