...
require 'src/states/entity/player/PlayerIdlePickUpState'
require 'src/states/entity/player/PlayerWalkPickUpState'
...
gSounds = {
    ...
    ['heart'] = love.audio.newSource('sounds/heart.wav')
}